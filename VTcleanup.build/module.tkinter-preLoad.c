...
static void createModuleConstants(void) {
    const_str_digest_30726611e59fa5fa6b5721deb8c88bbb = UNSTREAM_STRING_ASCII(&constant_bin[ 3799 ], 24, 0);
    const_str_plain_environ = UNSTREAM_STRING_ASCII(&constant_bin[ 3823 ], 7, 1);
    const_tuple_str_plain_TCL_LIBRARY_none_tuple = PyTuple_New(2);
    const_str_plain_TCL_LIBRARY = UNSTREAM_STRING_ASCII(&constant_bin[ 3830 ], 11, 1);
    ...
    const_str_digest_0492865e46cd96ee17148a12c234a543 = UNSTREAM_STRING_ASCII(&constant_bin[ 3841 ], 19, 0);
    const_str_plain_origin = UNSTREAM_STRING_ASCII(&constant_bin[ 3860 ], 6, 1);
    const_str_plain_tcl = UNSTREAM_STRING_ASCII(&constant_bin[ 3866 ], 3, 1);
    const_str_plain_has_location = UNSTREAM_STRING_ASCII(&constant_bin[ 3869 ], 12, 1);
    const_str_plain_TK_LIBRARY = UNSTREAM_STRING_ASCII(&constant_bin[ 3881 ], 10, 1);
    const_str_plain___nuitka_binary_dir = UNSTREAM_STRING_ASCII(&constant_bin[ 514 ], 19, 1);
...
// Mark the execution in the "__spec__" value.
    ...
    branch_yes_1:;
    {
        ...
        if (tmp_mvar_value_5 == NULL) {
            ...
            exception_type = PyExc_NameError;
            Py_INCREF(exception_type);
            exception_value = UNSTREAM_STRING(&constant_bin[ 508 ], 41, 0);
            exception_tb = NULL;
            NORMALIZE_EXCEPTION(&exception_type, &exception_value, &exception_tb);
            CHAIN_EXCEPTION(exception_value);
